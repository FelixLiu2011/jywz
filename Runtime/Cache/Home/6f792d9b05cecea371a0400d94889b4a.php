...
<body>
	...
	<form action="https://www.paypal.com/cgi-bin/webscr" method="post" id="form2" target="_blank">
	<!-- 把钱付给哪个账户，把value改为你的帐号 -->
	<input type="hidden" name="business" value="15188334916@163.com">
	<!-- 定义按钮的类型. -->
	<input type="hidden" name="cmd" value="_xclick">
	<!-- 定义IPN的返回方式，2代表post. -->
	<input type="hidden" name="rm" value="2">
	<!-- 用户付款成功后跳转去哪个页面. -->
	<input type="hidden" name="return" value="http://www.roselove68.com/Kby1">
	<!-- 很重要，自己定义的值. -->
