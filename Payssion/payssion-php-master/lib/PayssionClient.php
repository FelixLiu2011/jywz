...
class PayssionClient
{
     ...
     */
    protected $api_url;
    protected $api_key = '206e98cb8863dea6'; //your api key
    protected $secret_key = '53a2eced4201bb1cb03f7ecc094a287d'; //your secret key
    ...
    {
    	if ($is_livemode) {
    		$this->api_url = 'https://www.payssion.com/payment/create.html';
    	} else {
    		$this->api_url = 'http://sandbox.payssion.com/payment/create.html';
    	}
    }
